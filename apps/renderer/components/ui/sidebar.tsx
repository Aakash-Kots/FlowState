...
/** Access the sidebar's open/collapsed state; throws outside a SidebarProvider. */
function useSidebar() {
...
>(
  (
    ...
    // The Cmd/Ctrl+B toggle lives in the central keymap (ShortcutProvider bridges
    // `toggleSidebar` into the command registry), so this primitive no longer
    // owns its own global listener.
